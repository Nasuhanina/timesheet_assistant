            ...
            <>
              <div className="form-group">
                ...
                <select name="project_id" value={form.project_id} onChange={handleChange} required>
                  ...
                  <option value="NKM-2501-E-DRR-PMC">NKM-2501-E-DRR-PMC</option>
                  <option value="NKM-2502-E-MLIT-PMC">NKM-2502-E-MLIT-PMC</option>
                  <option value="NKM-DATA-PROCESSING">NKM-DATA-PROCESSING</option>
                  <option value="NKMOBI-internal">NKMOBI-internal</option>
                  <option value="NKBP-SG">NKBP-SG</option>
            ...
            <>
              <div className="form-group">
                ...
                <select name="activity_code" value={form.activity_code} onChange={handleChange} required>
                  ...
                  <option value="NM0-Mtg. HQ">NM0-Mtg. HQ</option>
                  <option value="NM1-Mtg. Gen">NM1-Mtg. Gen</option>
                  <option value="NM3-Mtg. Fest.">NM3-Mtg. Fest.</option>
                  <option value="NOM-Office Mgmt.">NOM-Office Mgmt.</option>
                  <option value="NKM-PC-Admin">NKM-PC-Admin</option>
                  <option value="NKM-PC-Recruit">NKM-PC-Recruit</option>
                  <option value="NKM-PC-Payroll">NKM-PC-Payroll</option>
                  <option value="NKM-PC-Statutory">NKM-PC-Statutory</option>
                  <option value="NKM-PC-CompBen">NKM-PC-CompBen</option>
                  <option value="NKM-PC-ER">NKM-PC-ER</option>
                  <option value="NKM-PC-Contract">NKM-PC-Contract</option>
                  <option value="NKM-PC-Training">NKM-PC-Training</option>
                  <option value="NKM-PC-Talent">NKM-PC-Talent</option>
                  <option value="NKM-PC-IR">NKM-PC-IR</option>
                  <option value="NKM-PC-Policy">NKM-PC-Policy</option>
                  <option value="NKM-PC-Audit">NKM-PC-Audit</option>
                  <option value="NKM-PC-Branding">NKM-PC-Branding</option>
                  <option value="NKM-PC-Wellness">NKM-PC-Wellness</option>
                  <option value="NKM-PC-Reporting">NKM-PC-Reporting</option>
                  <option value="NKM-Admin-Ops">NKM-Admin-Ops</option>
                  <option value="NKM-Admin-Facility">NKM-Admin-Facility</option>
                  <option value="NKM-Admin-Support">NKM-Admin-Support</option>
                  <option value="NKM-BD-Mtg-Int">NKM-BD-Mtg-Int</option>
                  <option value="NKM-BD-Mtg-Ext">NKM-BD-Mtg-Ext</option>
                  <option value="NKM-BD-Proposal">NKM-BD-Proposal</option>
                  <option value="NKM-BD-CV">NKM-BD-CV</option>
                  <option value="NKM-BD-TdrBrief">NKM-BD-TdrBrief</option>
                  <option value="NKM-BD-DocMgmt">NKM-BD-DocMgmt</option>
                  <option value="NKM-BD-Other">NKM-BD-Other</option>
                  <option value="NKM-COM-Invoice">NKM-COM-Invoice</option>
                  <option value="NKM-COM-Timesheet">NKM-COM-Timesheet</option>
                  <option value="NKM-COM-VendorReg">NKM-COM-VendorReg</option>
                  <option value="NKM-COM-PayMgmt">NKM-COM-PayMgmt</option>
                  <option value="NKM-COM-Contract">NKM-COM-Contract</option>
                  <option value="NKM-COM-Collection">NKM-COM-Collection</option>
                  <option value="NKM-COM-Others">NKM-COM-Others</option>
                  <option value="NKM-FIN-DataEntry">NKM-FIN-DataEntry</option>
                  <option value="NKM-FIN-Einvoice">NKM-FIN-Einvoice</option>
                  <option value="NKM-FIN-payments">NKM-FIN-payments</option>
                  <option value="NKM-FIN-Budget">NKM-FIN-Budget</option>
                  <option value="NKM-FIN-Cashflow">NKM-FIN-Cashflow</option>
                  <option value="NKM-FIN-HQReport">NKM-FIN-HQReport</option>
                  <option value="NKM-FIN-MonthClose">NKM-FIN-MonthClose</option>
                  <option value="NKM-FIN-YearClose">NKM-FIN-YearClose</option>
                  <option value="NKM-FIN-Tax">NKM-FIN-Tax</option>
                  <option value="NKM-FIN-YEAudit">NKM-FIN-YEAudit</option>
                  <option value="NKM-FIN-AuditFollow">NKM-FIN-AuditFollow</option>
                  <option value="NKM-C-Dev">NKM-C-Dev</option>
                  <option value="NKM-C-Rep">NKM-C-Rep</option>
                  <option value="NKM-C-Mtg">NKM-C-Mtg</option>
                  <option value="NKM-C-Awc">NKM-C-Awc</option>
                  <option value="NKM-Q-DC">NKM-Q-DC</option>
                  <option value="NKM-Q-Aud">NKM-Q-Aud</option>
                  <option value="NKM-Q-Mtg">NKM-Q-Mtg</option>
                  <option value="NKM-Q-Rev">NKM-Q-Rev</option>
                  <option value="NKM-RM-Rep">NKM-RM-Rep</option>
                  <option value="NKM-RM-Mtg">NKM-RM-Mtg</option>
                  <option value="NKM-TRN-Int">NKM-TRN-Int</option>
                  <option value="NKM-TRN-HQ">NKM-TRN-HQ</option>
                  <option value="NKM-S-Mtg">NKM-S-Mtg</option>
                  <option value="NKM-S-DM">NKM-S-DM</option>
                  <option value="NKM-S-Dev">NKM-S-Dev</option>
                  <option value="NKM-S-Rep">NKM-S-Rep</option>
                  <option value="NKM-G-Mtg">NKM-G-Mtg</option>
                  <option value="NKM-G-Com">NKM-G-Com</option>
                  <option value="NKM-G-Adm">NKM-G-Adm</option>
                  <option value="NKM-DATA-VISUALIZATION">NKM-DATA-VISUALIZATION</option>
                  <option value="NKM-DATA-RESEARCH">NKM-DATA-RESEARCH</option>
                  <option value="NKM-DATA-AI&ML">NKM-DATA-AI&amp;ML</option>
                  <option value="NKM-DATA-DEVELOPMENT">NKM-DATA-DEVELOPMENT</option>
                  <option value="NKM-DATA-DOCUMENTATION">NKM-DATA-DOCUMENTATION</option>
                  <option value="NKM-DATA-INTERNAL SYSTEM DEVELOPMENT">NKM-DATA-INTERNAL SYSTEM DEVELOPMENT</option>
                  <option value="NOA-Other">NOA-Other</option>
                </select>
              </div>
              <div className="form-group">
